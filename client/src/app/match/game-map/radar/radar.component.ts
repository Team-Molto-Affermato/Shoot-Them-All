...
export class RadarComponent implements OnInit, OnDestroy {
  ...
  private longitudeDistanceFromCenter(longitude) {
    return CoordinatesHelper.longitudeDistanceInMeters(this.matchComponent.position.longitude, longitude,
      this.matchComponent.position.latitude)
  }

  private latitudeDistanceFromCenter(latitude) {
    return CoordinatesHelper.latitudeDistanceInMeters(this.matchComponent.position.latitude, latitude)
  }
